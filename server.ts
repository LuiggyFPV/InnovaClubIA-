...
import { generateJsonFromPrompt, jsonEndpoint } from "./server-utils";
...
Estructura de respuesta requerida:
{
  ...
  "videos": [
    ...
    const data = await generateJsonFromPrompt(prompt, 0.2);
    res.json(data);
  } catch (error: any) {
...

{
  ...
  "recomendacion": "Estrategia de localización definitiva para penetrar esta zona de forma exitosa frente al radar obtenido."
    ...
    const data = await generateJsonFromPrompt(prompt, 0.3);
    res.json(data);
  } catch (error: any) {
